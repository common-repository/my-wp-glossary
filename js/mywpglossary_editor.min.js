...
(function (wp) {
  ...
  var PluginPrePublishPanelTest = function PluginPrePublishPanelTest() {
    ...
    var authorized = ["mywpglossary"];

    if (!authorized.includes(postType)) {
      return null;
    }

    var letter_choose = jQuery('#meta_box_mywpglossary_letter').val();
    ...
    return /*#__PURE__*/React.createElement(Fill, null, /*#__PURE__*/React.createElement(PanelBody, {
      title: __('Definition’s letter', 'my-wp-glossary'),
      icon: "editor-textcolor",
      initialOpen: true
    }, /*#__PURE__*/React.createElement(PanelRow, {
      className: "my-wp-glossary-checklist"
